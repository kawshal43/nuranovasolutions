...
export const serviceContraller = {
  page: {
    padding: "clamp(56px, 7vw, 82px) 0 clamp(68px, 8vw, 96px)",
    paddingMobile: "68px 0 42px",
    ...
    gridGapMobile: "22px",
    dividerMargin: "clamp(12px, 1.8vw, 18px) 0 clamp(22px, 2.6vw, 30px)",
    dividerMarginMobile: "10px 0 18px",
    dividerHeight: "1px",
